                ...
                <div className="col-span-2 md:col-span-1">
                    ...
                    {isCreatingCategory ? (
                        ...
                        <select className={COMMON_STYLES.select(isDarkMode)} value={newItem.category} onChange={e => {
                            ...
                            <option value="" className={isDarkMode ? "bg-black text-white" : ""}>Select...</option>
                            {categories.map(c => <option key={c} value={c} className={isDarkMode ? "bg-black text-white" : ""}>{c}</option>)}
                            <option value="__new__" className={`font-bold text-blue-500 ${isDarkMode ? "bg-black" : ""}`}>+ Create New</option>
                        </select>
                    )}
                </div>
              </div>
